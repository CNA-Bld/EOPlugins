...
namespace WhiteFleet
{
    class WhiteObserver
    {
        ...
        private static readonly WhiteObserver instance = new WhiteObserver();

        public static WhiteObserver Instance
        {
            get { return instance; }
        }
        ...
        private static int[] TargetShips = { 24, 25, 114 }; // Ooi, Kitagami, Abukuma
